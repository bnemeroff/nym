---
title: "Nym Tokenomics: $NYM Staking, Rewards & Supply"
description: "Understand NYM token economics including staking targets, mix-mining rewards, stake saturation, node selection, and how operator rewards are calculated."
